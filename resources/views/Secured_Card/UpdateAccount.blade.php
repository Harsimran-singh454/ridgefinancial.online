    ...
    <div class="form-container">
        ...
        <form action="{{route('editscrcardprocc', $info->id)}}" method="post">
            ...
            <div>
                ...
                <input type="number" name="account_number" value="{{$info->account_number}}" required>
        ...
        <a href="{{route('deleteSecrd', $info->id)}}" style="background-color: rgba(237, 36, 36, 0.701); text-decoration:none; color:white; padding: 1%;">Delete</a>
    </div>
